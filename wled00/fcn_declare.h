...
bool deserializeState(JsonObject root, byte callMode = CALL_MODE_DIRECT_CHANGE, byte presetId = 0, bool* espNowFloodAccepted = nullptr);
...
bool isClockSyncedPlaylistActive();
// AI: end
...
void applyESPNowFloodTimebase(uint8_t presetId = 0);
