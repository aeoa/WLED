...
WLED_GLOBAL bool espNowFloodRestrictPeers _INIT(false); // only accept command flood frames from linked MACs
// AI: end
//WLED_GLOBAL char linked_remote[13]   _INIT("");     // MAC of ESP-NOW remote (Wiz Mote)
// AI: below section was generated by an AI
WLED_GLOBAL std::vector<std::array<char, 13>> linked_remotes; // MACs of ESP-NOW remotes and allowed mesh neighbors
// AI: end
